...
const TableProfilingDisplay: React.FC<{
  profilingData: any;
  dataDictionary: any;
  anomalyData: any;
  similarityData?: any;
...
}> = ({ profilingData, dataDictionary, anomalyData, similarityData, uploadData, relationshipData, profilingSession, isStep4Skipped = false, exportRef }) => {
